...
import { nestConfigured } from './nest.js';
...
export const comingSoon = (): ApplianceSummary[] => nestConfigured() ? [] : [{ id: 'ac', name: 'AC', status: 'coming', watts: null, kwhPerDay: null, savesPerMonth: null, source: 'Nest' }];
